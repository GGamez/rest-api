 ...
 * Module dependencies.
 */
const EOL = require('jsonexport/lib/core/eol')
const joinRows = require('jsonexport/lib/core/join-rows');
const Handler = require('jsonexport/lib/parser/handler');
const helper = require('jsonexport/lib/core/helper');
...
class Parser {
    constructor(options) {
        ...
        this._escape = require('jsonexport/lib/core/escape-delimiters')(
